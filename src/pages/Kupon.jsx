          ...
          <div className="profile-page-list">
            <div className="profile-page-list-content">
              <ul>
                ...
                <li>
                  <NavLink to="/react_project/profile/orders">
                    Sifarişlərim
                  </NavLink>
                </li>
              </ul>
          ...
          <div className="kupon-content">
            ...
            <div className="kupon-card">
              ...
              <div className="kupon-card-text">
                <h3>
                  {" "}
                  Coffee Adnsu şəbəkəsinin əksər qəhvəxanalarında menyumuzdan yeməklər və
                  içkilər üçün 10 manat. Hədiyyə kartı sizə hədiyyə kartının
                  nominal dəyərindən çox olmayan qiymətə pulsuz sifariş almaq
                  hüququ verir.
                </h3>
              </div>
              <span>10 ₼</span>
            ...
            <div className="kupon-card">
              ...
              <div className="kupon-card-text">
                <h3>
                  Coffee Adnsu şəbəkəsinin əksər qəhvəxanalarında menyumuzdan yeməklər
                  və içkilər üçün 30 manat. Hədiyyə kartı sizə hədiyyə kartının
                  nominal dəyərindən çox olmayan qiymətə pulsuz sifariş almaq
                  hüququ verir.
                </h3>
              </div>
